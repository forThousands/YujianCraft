...
public final class TechniqueConfig {
    ...
    private static final ForgeConfigSpec.IntValue QI_GATHER_TICKS;
    private static final ForgeConfigSpec.IntValue QI_HOLD_TICKS;
    private static final ForgeConfigSpec.DoubleValue QI_HEIGHT;
    private static final ForgeConfigSpec.DoubleValue QI_RADIUS_PADDING;
    ...
    static {
        ...
        QI_GATHER_TICKS = BUILDER.defineInRange("gatherTicks", 12, 4, 80);
        QI_HOLD_TICKS = BUILDER.defineInRange("holdTicks", 12, 2, 80);
        QI_HEIGHT = BUILDER.defineInRange("formationHeight", 4.0D, 1.5D, 16.0D);
        QI_RADIUS_PADDING = BUILDER.defineInRange("radiusPadding", 1.8D, 0.5D, 8.0D);
        BUILDER.pop();
    ...
    public static int qiGatherTicks() { return QI_GATHER_TICKS.get(); }
    public static int qiHoldTicks() { return QI_HOLD_TICKS.get(); }
    public static double qiHeight() { return QI_HEIGHT.get(); }
    public static double qiRadiusPadding() { return QI_RADIUS_PADDING.get(); }
